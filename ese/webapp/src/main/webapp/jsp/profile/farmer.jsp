...
function getBankDetails(){
	...
	bankInformation["bankName"] = $("#bankName").val();
	bankInformation["branchName"] = $("#branchName").val();
	bankInformation["sortCode"] = $("#sortCode").val();
	
	
	
	if (!isEmpty($("#accNo").val()) && !isEmpty($("#bankName").val())){
...
.select2-container--default .select2-selection--single .select2-selection__rendered
	...
	<s:form name="form" cssClass="fillform" action="farmer_%{command}"
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group surName">
								...
								<div class="">
									<s:textfield id="surName" name="farmer.surName" maxlength="50"
										cssClass="upercls form-control" />
								</div>
							</div>
						</div>
					...
					<div class="row">
							...
							<div class="form-group gender">
								...
								<div class="">
									<s:select list="genderType" listKey="key" listValue="value"
										cssClass="form-control" id="gender" name="farmer.gender" />
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group dateOfBirth">
								<label for="txt"><s:property
										value="%{getLocaleProperty('farmer.dateOfBirth')}" /> </label>
								<div class="">
						...
						<div class="col-md-4">
							<div class="form-group age">
								<label for="txt"><s:property
										value="%{getLocaleProperty('farmer.age1')}" /> </label>
								<div class="">
									<s:textfield id="age" name="farmer.age" readonly="true"
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="custom-file">
									...
									<input type="file" class="custom-file-input" name="farmerImage"
										id="farmerImage" tooltip="Upload Farmer Photo"
										label="Farmer Photo" onchange="validateImage()"> <label
										class="custom-file-label" for="customFile"><s:property
											value="%{getLocaleProperty('farmer.photo')}" /></label>
						...
						<div class="col-md-4">
							<div class="form-group idProof">
								<label for="txt"> <s:property
										value="%{getLocaleProperty('farmer.idProof')}" />
								</label>
								<div class="">
									<s:select cssClass="form-control " id="idProof"
										name="farmer.idProof" list="proofList" headerKey="-1"
										headerValue="%{getText('txt.select')}"
										onChange="processIdProof(this.value);" />
								</div>
							</div>
						</div>

						<div class="col-md-4 idProof idType">
							<div class="form-group ProofNo">
								<label for="txt"> <s:property
										value="%{getLocaleProperty('farmer.ProofNo')}" />
								</label>
								<div class="">
									<s:textfield name="farmer.proofNo" theme="simple"
										maxlength="20" id="proofNoInputVal" cssClass="form-control " />
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-4 proofIdOther">
							<div class="form-group ">
								...
								<div class="">
									<s:textfield id="proofIdOtherVal" name="farmer.otherIdProof"
										theme="simple" maxlength="12" cssClass="form-control " />
								</div>
							</div>
						</div>
						...
						<!-- <div class="col-md-4">
							<div class="form-group idProofImg">
								<label for="txt"> <s:property
										value="%{getLocaleProperty('farmer.idProofImg')}" /> <%-- <span
							style="font-size: 8px"> <s:text name="farmer.imageTypes" />
								<font color="red"> <s:text name="imgSizeMsg" /></font>
						</span> <s:if
								test="currentTenantId=='livelihood'"> </s:if> --%>
								</label>
								<div class="form-control">
									<s:file name="idProofImg" id="idProofImg"
										onchange="checkImgHeightAndWidth(this)"
										tooltip="Upload Id Proof" label="Id Proof" />

									<s:if test="command =='update' && farmer.idProofImg!=null">
										<button type='button' class='btn btn-sm pull-right photo'
											style='margin-right: 15%'
											onclick="enableFarmerPhotoModal(<s:property value="farmer.id"/>,2)">
											<i class='fa fa-picture-o' aria-hidden='true'></i>
										</button>
									</s:if>
								</div>
		...
		<div id="accordion" class="custom-accordion contact_info">
						...
						<h6 class="m-0">
							<div class="wizard-wrapper">
								...
								<div class="wizard-label">
									...
									<div class="wizard-desc">Setup Farmer Contact & Location
										Details</div>
								</div>
							</div>
							<i
			...
			<div id="contInfo" class="collapse show" aria-labelledby="headingTwo"
				data-parent="#accordion">
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group mobileNumber">
								...
								<div class="">
									<s:textfield name="farmer.mobileNumber" maxlength="15"
						...
						<div class="col-md-4">
							<div class="form-group email">
								...
								<div class="">
									<s:textfield cssClass="form-control" name="farmer.email"
										size="90" maxlength="45" />
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group locationInfo">
								<label for="txt"><s:property
										value="%{getLocaleProperty('country.name')}" /> </label>
								<div class="">
						...
						<div class="col-md-4">
							<div class="form-group locationInfo">
								<label for="txt"><s:property
										value="%{getLocaleProperty('state.name')}" /> </label>
								<div class="">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group group">
								...
								<div class="">
									<s:select name="selectedSamithi"
										cssClass="form-control select2" id="samithii" list="samithi"
		...
		<div id="accordion" class="custom-accordion farmer_info">
						...
						<h6 class="m-0">
							<div class="wizard-wrapper">
								...
								<div class="wizard-label">
									...
									<h3 class="wizard-title">
										<s:property value="%{getLocaleProperty('ICS Information')}" />
									</h3>
			...
			<div id="farmerInfo" class="collapse show"
				...
				<div class="card-body">
					...
					<div class="row">
							...
							<div class="form-group certified">
								...
								<div class="">
									<s:select id="farmerCertified" list="isFarmerCertified"
										name="farmer.isCertifiedFarmer"
										value="FarmerCertifiedDefaultValue"
						...
						<div class="col-md-4">
							<div class="form-group isCertifiedFarmer icsFields hide icsName ">
								...
								<div class="">
									<s:textfield id="icsName" name="farmer.icsName"
										cssClass="upercls form-control" maxlength="90" />
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group isCertifiedFarmer icsFields hide icsCode">
								...
								<div class="">
									<s:textfield id="icsCode" name="farmer.icsCode" maxlength="35"
										cssClass="upercls form-control" />
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div
								class="form-group isCertifiedFarmer certificationType hide cerType">
								<label for="txt"> <s:text name="certification.type" />
						...
						<h6 class="m-0">
							<div class="wizard-wrapper">
								...
								<div class="wizard-label">
									...
									<h3 class="wizard-title">
										<s:property value="%{getLocaleProperty('Other Information')}" />
									</h3>
							...
							<div class="form-group noOfFamilyMembers">
								...
								<div class="">
									<s:textfield id="familyMembers" name="farmer.noOfFamilyMembers"
										maxlength="2" cssClass="upercls form-control"
						...
						<div class="col-md-4">
							<div class="form-group housingOwnershipProp ">
								<label for="txt"> <s:text
										name="farmer.housingOwnershipProp" /><sup style="color: red;">*</sup>
								</label>
								<div class="">
							...
							<div class="form-group lifeInsur">
								...
								<div class="">
									<s:select id="life" list="listInsurance"
										...
										onchange="lifeInsureAmt(this.value);"
							...
							<div class="form-group isLoanTakenLastYearProp">
								...
								<div class="">
									<s:select id="LoanTakenLastYear" list="isLoanTakenLastYear"
										...
										onchange="loanTakenFromDiv(this);"
										cssClass="form-control select2" />
		...
		<div id="accordion" class="custom-accordion bank_info">
			<div class="card-header card mb-1 shadow-none">
						...
						<h6 class="m-0">
							<div class="wizard-wrapper">
								...
								<div class="wizard-label">
									...
									<h3 class="wizard-title">
										<s:property value="%{getLocaleProperty('Bank Information')}" />
									</h3>
			...
			<div id="bankInfo" class="collapse show"
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group noOfFamilyMembers">
								<label for="txt"> <s:text name="farmer.bankInfo.accName" />
								</label>
								<div class="">
									<input type="text" class="form-control" id="accName"
										name="accName" maxlength="25">
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="form-group noOfFamilyMembers">
								<label for="txt"> <s:text name="farmer.bankInfo.accNo" />
								</label>
								<div class="">
									<input type="text" class="form-control" id="accNo" name="accNo"
										onkeypress="return isNumber(event)" maxlength="25">
								</div>
							</div>
						</div>
							...
							<div class="form-group noOfFamilyMembers">
								...
								<div class="">
									<input type="text" class="form-control" id="sortCode"
										name="sortCode" onkeypress="return isAlphaNumeric(event)"
										maxlength="35">
								</div>
							</div>
						</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="modal-form">
							...
							<div class="modal-form-item">
								<label><b><FONT color="#111111"><s:property
												value="%{getLocaleProperty('farmer.bankInfo.AccountTypeProp')}" /></FONT></b>
									<s:if test="getCurrentTenantId()!='farmAgg' ">
										<sup style="color: red;">*</sup>
									</s:if></label>
								<s:select class="form-control" id="accountType" listKey="key"
									listValue="value" name="accType" list="accountTypeList"
							...
							<s:if test="getCurrentTenantId()=='farmAgg' ">
								<div class="modal-form-item">
									<label><b><FONT color="#111111"><s:text
													name="farmer.bankInfo.accName" /></FONT></b> <!-- <sup
									style="color: red;">*</sup> --></label> <input type="text"
										class="form-control" id="accName" name="accName"
										maxlength="25">
								</div>
							</s:if>
							...
							<div class="modal-form-item">
								<label><b><FONT color="#111111"><s:text
												name="farmer.bankInfo.accNo" /></FONT></b> <sup style="color: red;">*</sup></label>
								<input type="text" class="form-control" id="accNo" name="accNo"
									onkeypress="return isNumber(event)" maxlength="25">
							</div>
							<s:if test="currentTenantId!='chetna'">
								<div class="modal-form-item">
									<label><b><FONT color="#111111"><s:text
													name="farmer.bankInfo.bankName" /></FONT></b> <sup
										style="color: red;">*</sup></label> <input type="text"
								...
								<div class="modal-form-item">
									<label><b><FONT color="#111111"><s:text
													name="farmer.bankInfo.branchName" /></FONT></b> <s:if
											test="getCurrentTenantId()!='farmAgg' ">
											<sup style="color: red;">*</sup>
										</s:if></label> <input type="text" class="form-control" id="branchName"
										name="branchName">
								</div>
							</s:if>
							<s:else>
								...
								<div class="modal-form-item">
									<label><b><FONT color="#111111"><s:text
													name="farmer.bankInfo.branchName" /></FONT></b> <sup
										style="color: red;">*</sup></label>
									<s:select class="form-control" style="width:200px"
							...
							<s:if test="getCurrentTenantId()=='farmAgg' ">
								<div class="modal-form-item">
									<label><b><FONT color="#111111"><s:text
													name="farmer.bankInfo.swiftCode" /></FONT></b></label> <input type="text"
										class="form-control" id="swiftCode" name="swiftCode"
										onkeypress="return isAlphaNumeric(event)" maxlength="35">
								</div>
							</s:if>
							...
							<s:if test="getCurrentTenantId()!='sticky' ">
								<div class="modal-form-item">
									<label><b><FONT color="#111111"><s:property
													value="%{getLocaleProperty('farmer.bankInfo.sortCode')}" /></FONT></b>
										<s:if test="getCurrentTenantId()!='farmAgg' ">
											<sup style="color: red;">*</sup>
										</s:if></label> <input type="text" class="form-control" id="sortCode"
										name="sortCode" onkeypress="return isAlphaNumeric(event)"
										maxlength="35">
								</div>
							</s:if>
					...
					<div class="modal-footer">
						<button type="button" class="save-btn btn btn-success"
							id="saveBankDetail" onclick="saveBankInformation(this)">
