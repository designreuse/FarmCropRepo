...
function getBranchIdDyn(){
	...
	<div>
			...
			<button type="BUTTON" id="add" onclick="document.createform.submit()" class="btn btn-success mb-2 float-right" >Add Farmer <i class="ri-menu-add-line align-middle ml-2"></i></button>
			</sec:authorize>
