...
<html lang="en" class="no-js">		
    <head>
        <title><decorator:title default="THE FARM CORP - Next Generation Tech Solution"/></title> 
 ...
 <s:form name="form" cssClass="fillform" action="license_save">
        ...
        <div class="licenseWrapper col-md-offset-4 col-md-4">
                           ...
                           <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <img class="d-block img-fluid" src="assets/images/slider-1.jpg" alt="First slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="assets/images/slider-2.jpg" alt="Second slide">
                                                </div>
                                                <div class="carousel-item">
                                                    <img class="d-block img-fluid" src="assets/images/slider-3.jpg" alt="Third slide">
                                                </div>
                                            </div>
