 ...
 */
public class FarmerInspectionOrganicReportAction extends BaseReportAction {

	private static final long serialVersionUID = 1L;
	private static final String CATEGORY_CODE = "CC002";
	...
	public JSONObject toJSON(Object obj) {
		...
		/*
		 * rows.add(!StringUtil.isEmpty(farmerName) ? farmerName :
		 * getText("NA"));
		 */
	...
	public String populateXLS() throws Exception {
		...
		setXlsFileName(getText("FarmerInspectionOrganicReport") + fileNameDateFormat.format(new Date()));
	...
	private InputStream getExportDataStream(String exportType)throws IOException {
		...
		cell.setCellValue(new HSSFRichTextString(getLocaleProperty("farmerInspectionOrganicReportTitle")));
		...
		if (StringUtil.isEmpty(branchIdValue)) {
			mainGridColumnHeaders = getLocaleProperty("farmerInspectionOrganicBranch");
		}else{
			mainGridColumnHeaders = getLocaleProperty("farmerInspectionOrganic");
		}
