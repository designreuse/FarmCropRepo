...
public class UserValidator implements IValidator {
    ...
    public Map<String, String> validate(Object user) {
        ...
        if (StringUtil.isEmpty(aUser.getContactInfo().getMobileNumber())) {
                ...
                errorCodes.put("empty.mobile", "empty.mobile");
        ...
        if (StringUtil.isEmpty(aUser.getPassword())) {
            errorCodes.put("empty.password", "empty.password");
        }
        if (StringUtil.isEmpty(aUser.getConfirmPassword())) {
            errorCodes.put("empty.confirmPassword", "empty.confirmPassword");
        }
        return errorCodes;
    }
